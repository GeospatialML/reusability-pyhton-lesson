...
* Competent Python programmer NB: we need to define what we mean by *competent* = working knowledge --> use a link/list to be as specific as possible. Look at this [example](https://datacarpentry.github.io/image-processing/prereqs.html). Check the prerequisites section and then link therein.
